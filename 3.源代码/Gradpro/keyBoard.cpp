...
void keyBoard::slotBtnClicked()
{
    ...
    QString objectName = btn->objectName();//保存此对象名称
...
/**************************************
 * 函数名称：  keyBoard::InitWindow()
 * 函数功能： 初始化窗口布局
 *=========================
 * 修改人  修改内容    最新修改日期
 * laried   创建         2020年4月14日
***************************************/
void keyBoard::InitWindow()
{
    ...
    infoLabel->setText(tr("森之曦 1.0 软键盘制作 2020年4月14日 "));
...
/**************************************
 * 函数名称：keyBoard::changeType()
 * 函数功能： 改变输入法类型
 *=========================
 * 修改人  修改内容    最新修改日期
 * laried   创建     2020年4月15日
***************************************/
...
/**************************************
 * 函数名称：keyBoard::changeType()
 * 函数功能： 改变字母大小写,根据按钮的property属性找出全部字母按钮
 *=========================
 * 修改人  修改内容    最新修改日期
 * laried   创建     2020年4月15日
***************************************/
void keyBoard::changeLetter(bool isUpper)
{
    ...
    foreach (QPushButton * b, btn)
    {
        if (b->property("letter").toBool())
        {
            if (isUpper)
            {
                b->setText(b->text().toUpper());//字母转大写
            }
            else
            {
                b->setText(b->text().toLower());//字母转小写
            }
        }
    }
}
...
/**************************************
 * 函数名称：keyBoard::setStyle()
 * 函数功能： 设置键盘风格
 *=========================
 * 修改人  修改内容    最新修改日期
 * laried   创建     2020年4月15日
***************************************/
void keyBoard::setStyle(QString topColor, QString bottomColor,
